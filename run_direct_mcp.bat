@echo off
echo ===================================================
echo   AI Code Translator Direct MCP Server
echo ===================================================
echo.
echo Setting up Gemini API key and starting Direct MCP server...
echo.
...
REM Run the server
python direct_mcp_server.py --host 127.0.0.1 --port 8000
